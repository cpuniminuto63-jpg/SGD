-- RevisaSGD — vistas SQL para Tableau e indicadores
-- Todas las vistas heredan RLS de las tablas base (security_invoker) salvo indicación contraria.

-- ============================================================
-- vw_estado_actual_documentos — estado vigente = último review_event por expected_document
-- ============================================================
...
-- ============================================================
-- vw_historial_revisiones — una fila por cada acción de revisión
-- ============================================================
...
-- ============================================================
-- vw_avance_sede_apartado — % de cumplimiento por sede y apartado
-- ============================================================
...
-- ============================================================
-- vw_productividad_revisores — acciones de revisión por revisor y día
-- ============================================================
...
-- ============================================================
-- vw_retrabajo_documental — documentos revisados 2+ veces y su tasa de retrabajo
-- ============================================================
...
join document_sections ds on ds.id = ed.section_id
join document_catalog dc on dc.id = ed.document_catalog_id
group by ed.id, i.sede_name, i.mentor_name, i.coordinator_name, ds.name, dc.evidence_name
having count(re.id) > 1;

-- ============================================================
-- vw_pendientes_subsanacion — pendientes por subsanar y vencidos
-- ============================================================
...
comment on view vw_pendientes_subsanacion is 'Fuente para alertas de vencimiento (Fase 2).';
